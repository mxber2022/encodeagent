...
const STARKNET_PUBLIC_RPC =
    "https://starknet-mainnet.g.alchemy.com/starknet/version/rpc/v0_7/kaFl069xyvy3np41aiUXwjULZrF67--t";
...
console.log("process.env.STARKNET_ADDRESS: ", process.env.STARKNET_ADDRESS);
